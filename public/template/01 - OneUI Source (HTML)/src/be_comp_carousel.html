  ...
  <body>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item open">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <a class="nav-main-link active" href="be_comp_carousel.html">
      ...
      <main id="main-container">
        ...
        <!-- For advanced Carousel usage you can check out https://getbootstrap.com/docs/5.3/components/carousel/ -->
        <div class="content">
          <div class="row">
            <div class="col-md-6">
              <!-- Slides Only -->
                  ...
                  <div id="carouselExampleSlidesOnly" class="carousel slide carousel-fade" data-bs-interval="2000" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="assets/media/photos/photo1.jpg" class="d-block w-100" alt="Carousel Image 1">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo2.jpg" class="d-block w-100" alt="Carousel Image 2">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo3.jpg" class="d-block w-100" alt="Carousel Image 3">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                  <div id="carouselExampleIndicators" class="carousel slide carousel-fade">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="assets/media/photos/photo7.jpg" class="d-block w-100" alt="Carousel Image 1">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo8.jpg" class="d-block w-100" alt="Carousel Image 1">
                      </div>
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo9.jpg" class="d-block w-100" alt="Carousel Image 1">
                      </div>
                    </div>
              ...
              <div class="block block-rounded">
                ...
                <div class="block-content block-content-full">
                  <div id="carouselExampleCaptions" class="carousel slide">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="assets/media/photos/photo14.jpg" class="d-block w-100" alt="Carousel Image 1">
                      ...
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo21.jpg" class="d-block w-100" alt="Carousel Image 2">
                        <div class="carousel-caption d-none d-md-block bg-black-50 rounded-3 px-3">
                          <h5 class="h3 mb-2">
                            Greece
                          </h5>
                      ...
                      <div class="carousel-item">
                        <img src="assets/media/photos/photo19.jpg" class="d-block w-100" alt="Carousel Image 3">
                        <div class="carousel-caption d-none d-md-block bg-black-50 rounded-3 px-3">
                          <h5 class="h3 mb-2">
                            New Zealand
                          </h5>
